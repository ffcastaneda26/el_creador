    ...
    public function aviso_pricacidad($record)
    {
        ...
        for ($i = 1; $i <= $count; $i++) {
            ...
            if ($data) {
                ...
                $fpdi->Text(42, 133, $standard_name);
                $fpdi->Text(44, 145, $data->phone);
                $fpdi->Text(61, 157, strtolower($data->email));
                $address = $data->address . ' Col: ' . $data->colony . ' en ' . $data->city->name;
                ...
                $fpdi->Text(90, 183, $data->rfc);
                $fpdi->Text(64, 195, $data->ine);
                $fpdi->Text(40, 265, $standard_name);
            }
        }
