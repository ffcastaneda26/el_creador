                        ...
                        <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
                            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                                <div
                                            ...
                                            <div class="flex-shrink-0">
                                                <div class="w-full">
                                                    ...
                                                    <select wire:model.live.debounce.150ms="receipt_status"
                                                        wire:change="getRecords" id="receipt_status"
                                    ...
                                    <div
                                        class="w-full md:w-1/2 flex justify-end items-center {{ $can_create_receipts ? '' : 'hidden' }}">
                                        <x-button wire:click="create" class="bg-green-500 text-white px-4 py-2 rounded">
                                    ...
                                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                        <thead
                                            ...
                                            <tr class="bg-gray-300 text-center ">
                                                <th scope="col" class="px-4 py-3">{{ __('Folio') }}</th>
                                                    ...
                                                    {{-- <td
                                                        ...
                                                        @if ($record->can_be_suply())
                                                            <button wire:click="create" type="button"
                                                                class="text-black w-24 h-10  bg-green-800 hover:bg-blue-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
